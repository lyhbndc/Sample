...
if (isset($_POST['Add'])) {
        ...
        $image = "Movies/cover/11.png";
        $link = "Nausicaä of the Valley of the Wind.php";
        $user = $_SESSION['user'];
...
<head>
  ...
  <style>
    .wrapper {
      background-image: url('Movies/bg/11.png');
    }
  </style>
</head>
<body>
  <div class="wrapper">
    ...
    <div class="button-container">
      <a href="Movies/11. Nausicaä of the Valley of the Wind/nausicaa.html"><button class="button">Play</button></a>
    ...
    <section class="main-container">
      <div class="location" id="home">
          ...
          <div class="box">
            <a href="Movies/11. Nausicaä of the Valley of the Wind/nausicaa.html" class="my-link">
              <img src="Movies/11. Nausicaä of the Valley of the Wind/nausicaa_thumb_0.png" alt="">
